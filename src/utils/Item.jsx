  ...
  return (
    <>
      <div className={`relative bg-gradient-to-b ${color} ${shadow} grid items-center justify-items-center`} >
        <div className="grid items-center justify-items-center rounded-xl py-4 px-5 transition-all duration-700 ease-in-out w-full hover:scale-105">
          ...
          <div className="flex items-center justify-between w-28 my-2">
            ...
            <div className="flex items-center gap-1">
              <StarIcon className="icon-style text-slate-500 w-5 h-5 md:w-4 md:h-4 " />
          ...
          <div className="flex items-center gap-3">
            ...
            <button type="button" className="bg-white/90 blue-effect-theme button-theme p-0.5 shadow shadow-sky-200 text-sm text-black">{btn}</button>
          </div>
        </div>
